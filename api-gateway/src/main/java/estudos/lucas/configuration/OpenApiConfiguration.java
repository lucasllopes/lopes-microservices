...
public class OpenApiConfiguration {
    ...
    @Bean
    @Lazy(value = false) // deve carregar assim que o api gateway subir
    public List<GroupedOpenApi> apis (SwaggerUiConfigParameters config, RouteDefinitionLocator locator){

        // criando grupo de documentacao baseado na regex -service.
       var definitions = locator.getRouteDefinitions().collectList().block(); // block para bloquear o arquivo para leitura
